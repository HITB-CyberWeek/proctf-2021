...
namespace checker.rnd
{
	internal static class RndHttp
	{
		...
		private static readonly string[] UserAgents =
		{
			...
			"Java1.8.0_161",
			"Wget/1.21.2", "Wget/1.21.1",
			"Go-http-client/2.0", "Go-http-client/1.1",
			"Python-urllib/3.1", "Python-urllib/3.0", "Python-urllib/2.7",
			"python-requests/2.23.0", "python-requests/2.22.0", "python-requests/2.21.0",
			"Python/3.9 aiohttp/3.7.4", "Python/3.8 aiohttp/3.7.3", "Python/3.7 aiohttp/3.7.2",
			"libwww-perl/6.57", "libwww-perl/6.56", "libwww-perl 5.76",
			"curl/7.79.1", "curl/7.79.0", "curl/7.78.0",
